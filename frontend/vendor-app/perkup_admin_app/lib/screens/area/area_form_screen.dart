...
import 'package:perkup_admin_app/models/area/area.dart';
...
import 'package:perkup_admin_app/providers/city_provider.dart'; // Import CityProvider
import 'package:perkup_admin_app/providers/login_provider.dart';
import 'package:perkup_admin_app/models/city/city.dart'; // Import City model
...
class _AreaFormScreenState extends State<AreaFormScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    print('sdfsaf ${cityProvider.cities.map((e) => e.cityID).toList()}');
    return Scaffold(
      appBar: AppBar(
